<div class="flex justify-between items-center mb-6">
    <h1 class="text-2xl font-bold text-gray-900"><?= CNA\Utils\Language::t('clients.edit_client') ?></h1>
    <div class="space-x-3">
        <a href="/clients/<?= $client['id'] ?>" class="btn-secondary">
...
<div class="card">
    <form method="POST" action="/clients/<?= $client['id'] ?>" data-validate>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input 
                    ...
                    name="first_name" 
                    id="first_name" 
                    value="<?= $this->old('first_name', $client['first_name']) ?>"
            ...
            <div>
                ...
                <input 
                    ...
                    name="last_name" 
                    id="last_name" 
                    value="<?= $this->old('last_name', $client['last_name']) ?>"
                    class="form-input mt-1 block w-full" 
                    required
                >
            </div>
            ...
            <div>
                ...
                <input 
                    ...
                    name="company" 
                    id="company" 
                    value="<?= $this->old('company', $client['company']) ?>"
                    class="form-input mt-1 block w-full"
                >
            </div>
            ...
            <div>
                ...
                <input 
                    ...
                    name="email" 
                    id="email" 
                    value="<?= $this->old('email', $client['email']) ?>"
                    class="form-input mt-1 block w-full"
                >
            </div>
            ...
            <div>
                ...
                <input 
                    ...
                    name="phone" 
                    id="phone" 
                    value="<?= $this->old('phone', $client['phone']) ?>"
                    class="form-input mt-1 block w-full"
                    data-phone
                >
            </div>
            ...
            <div>
                ...
                <input 
                    ...
                    name="state" 
                    id="state" 
                    value="<?= $this->old('state', $client['state']) ?>"
                    class="form-input mt-1 block w-full"
                >
            </div>
        </div>
        ...
        <div class="mt-6">
            ...
            <textarea 
                ...
                rows="3" 
                class="form-input mt-1 block w-full"
            ><?= $this->old('address', $client['address']) ?></textarea>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
            ...
            <div>
                ...
                <input 
                    ...
                    name="city" 
                    id="city" 
                    value="<?= $this->old('city', $client['city']) ?>"
                    class="form-input mt-1 block w-full"
                >
            </div>
            ...
            <div>
                ...
                <input 
                    ...
                    name="zip_code" 
                    id="zip_code" 
                    value="<?= $this->old('zip_code', $client['zip_code']) ?>"
                    class="form-input mt-1 block w-full"
                >
            </div>
        </div>
        ...
        <div class="mt-6">
            ...
            ><?= $this->old('notes', $client['notes']) ?></textarea>
        </div>
